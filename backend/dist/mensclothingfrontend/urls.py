...
from .views import (LoginView, SignupView, LogoutView, ResetPasswordView, CategoryListView, CategoryDetailView, ProductListView, ProductDetailView, 
    ...
    AddressDetailView, CreateOrderView, ProfileView,VerifyPaymentView, RecommendationView, MyOrdersView, CancelOrderView, OrderTrackView, CancelOrderItemView)
...
urlpatterns = [
    ...
    path('orders/<int:order_id>/items/<int:item_id>/cancel/', CancelOrderItemView.as_view(), name='cancel-order-item'),
